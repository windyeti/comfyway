class Services::GettingProductDistributer::Stluce
  ...
  def self.call
    ...
    xlsx.sheets.each do |sheet_name|
      ...
      first_row_test = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Основной склад", "Склад Грибки", "Склад Шереметьево", "Количество в Москве", "Суммарные остатки", "Дата поступления", "Количество поступления", "Ссылка на картинку", "Свойства товара", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "Габариты товара (мм)", nil, nil, nil, nil, "Упаковка", nil, nil, nil, nil, nil, nil]
      ...
      raise "COMPARE ARRAYS 1" if second_row != second_row_test

      headers = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Основной склад", "Склад Грибки", "Склад Шереметьево", "Количество в Москве", "Суммарные остатки", "Дата поступления", "Количество поступления", "Ссылка на картинку", "Коллекция", "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм", "Ширина, мм", "Высота, мм", "Диаметр, мм", "Максимальная высота, мм", "Длина", "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]
