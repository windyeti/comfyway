class Services::GettingProductDistributer::Stluce
  ...
  def self.call
    ...
    xlsx.sheets.each do |sheet_name|
      ...
      # first_row_test = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки", "Склад Грибки wms", "Склад Шереметьево", "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки", "Дата поступления", "Количество поступления", "Ссылка на картинку", "Свойства товара", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "Габариты товара (мм)", nil, nil, nil, nil, "Упаковка", nil, nil, nil, nil, nil, nil]
      #
      # second_row_test = [nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "Коллекция", "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм", "Ширина, мм", "Высота, мм", "Диаметр, мм", "Высота макс., мм", "Длина", "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]

      first_row_test = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки wms", "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки", "Дата поступления", "Количество поступления", "Ссылка на картинку", "Свойства товара", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "Габариты товара (мм)", nil, nil, nil, nil, "Упаковка", nil, nil, nil, nil, nil, nil]
      second_row_test = [nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "Коллекция", "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм", "Ширина, мм", "Высота, мм", "Диаметр, мм", "Высота макс., мм", "Длина", "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]

      # если изменился файл, ничего не парсим
      p first_row - first_row_test
      p second_row - second_row_test
      raise "COMPARE ARRAYS 1" if first_row != first_row_test
      raise "COMPARE ARRAYS 2" if second_row != second_row_test

      # headers = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки", "Склад Грибки wms", "Склад Шереметьево", "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки", "Дата поступления", "Количество поступления", "Ссылка на картинку", "Коллекция", "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм", "Ширина, мм", "Высота, мм", "Диаметр, мм", "Максимальная высота, мм", "Длина", "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]

      # headers = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки",     "Склад Грибки wms",      "Склад Шереметьево",   "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки",      "Дата поступления",   "Количество поступления", "Ссылка на картинку", "Коллекция",      "Стиль",           "Тип светильника",   "Количество ламп", "Тип ламп",    "Мощность ламп, W", "Тип цоколя",   "Цвет каркаса",        "Цвет плафона",        "Поверхность каркаса", "Поверхность плафона", "Материал каркаса",     "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта",   "Тип крепления",      "Степень защиты",      "Световой поток, Lm", "Длина, мм",  "Ширина, мм",  "Высота, мм",      "Диаметр, мм", "Максимальная высота, мм", "Длина",  "Ширина",          "Высота",   "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]

      first_r = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки wms", "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки",     "Дата поступления",    "Количество поступления", "Ссылка на картинку", "Свойства товара", nil,     nil,               nil,               nil,        nil,                nil,          nil,            nil,            nil,                   nil,                   nil,                nil,                nil,                    nil,                 nil,              nil,                 nil,              nil,             nil,              nil,                  "Габариты товара (мм)", nil,          nil,          nil,           nil,               "Упаковка", nil,      nil,      nil,               nil,        nil,          nil]
      second_ = [nil,     nil,       nil,               nil,            nil,         nil,    nil,               nil,                      nil,                  nil,                     nil,                   nil,                      nil,                  "Коллекция",       "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм",            "Ширина, мм", "Высота, мм", "Диаметр, мм", "Высота макс., мм", "Длина",   "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод"]
      headers = ["Бренд", "Артикул", "Товарная группа", "Наименование", "Код ТНВЭД", "МРЦ", "Склад Грибки wms", "Склад Шереметьево wms", "Количество в Москве", "Суммарные остатки",     "Дата поступления",    "Количество поступления", "Ссылка на картинку", "Коллекция",       "Стиль", "Тип светильника", "Количество ламп", "Тип ламп", "Мощность ламп, W", "Тип цоколя", "Цвет каркаса", "Цвет плафона", "Поверхность каркаса", "Поверхность плафона", "Материал каркаса", "Материал плафона", "Цветовая температура", "Лампы в комплекте", "Общая мощность", "Площадь освещения", "Наличие пульта", "Тип крепления", "Степень защиты", "Световой поток, Lm", "Длина, мм",            "Ширина, мм", "Высота, мм", "Диаметр, мм", "Высота макс., мм", "Длина",   "Ширина", "Высота", "Из двух коробок", "Вес (кг)", "Объем (м3)", "Штрихкод", ]
