class Product < ApplicationRecord
  DISTRIBUTOR = [["", "Поставщик"], ["Maytoni", "Maytoni"], ["Mantra", "Mantra"], ["Lightstar", "Lightstar"], ["Ledron", "Ledron"], ["Swg", "Swg"], ["Elevel", "Elevel"], ["Isonex", "Isonex"], ["Loftit", "Loftit"], ["Favourite", "Favourite"], ["Kinklight", "Kinklight"], ["Stluce", "Stluce"]]
